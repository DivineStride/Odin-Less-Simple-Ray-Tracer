...
sample_square_stratified :: proc(cam: ^Camera, s_i, s_j: int) -> Vec3 {
	px := ((f64(s_i) + random_f64()) * f64(cam.recip_sqrt_spp)) - 0.5
	py := ((f64(s_j) + random_f64()) * f64(cam.recip_sqrt_spp)) - 0.5
